...
public class Launch {
	...
	System.out.println ("6 - Calcul nombre moyen de succeseurs d'un noeud");
	System.out.println ("7 - Programme du covoiturage");
	...
	try {
		...
		case 5 :
		    ...
		    System.out.println("Dist : " + graphe.calculerDistance());
		    System.out.println("temps : " + graphe.calculertemps());
		    break ;
		    
		case 6 : System.out.println("Nombre moyen : " + graphe.calculerNombreMoyen());
				break;
		case 7 :
					algo = new CovoiturageSimple(graphe, this.fichierSortie (), this.readarg) ; break ;
	...
	} catch(Pas_de_Synchro t)
	{
		System.out.println("Aucun point de Synchro n'a été trouvé");
	}
	catch (Throwable t) {
	    t.printStackTrace() ;
	    System.exit(1) ;
