...
public class Openfile {
	...
	// Le programme examine chaque dossier dans l'ordre jusqu'a trouver celui
	// qui contient la carte voulue
	private static final String[] datadirs = { // NE MODIFIEZ PAS CELUI-CI
			...
			// On cherche aussi dans le sous-repertoire local "Maps" (s'il
			// existe)
			"Maps",
			...
			// Si vous utilisez votre propre dossier pour les donnees, mettez-le
			// ici.
	...
	/**
	 * Ouvre le fichier indiqué et renvoie un DataInputStream sur ce fichier. Le
	 * fichier ne sera pas ferme avant la fin de l'application.
	 * 
	 * @param filename
	 *            Nom du fichier a ouvrir (sans chemin)
	 */
