...
public abstract class Dessin {
	...
	/**
	 * Indique les bornes de la fenetre graphique. Le calcul des coordonnees en
	 * pixel se fera automatiquement a l'appel des methodes drawLine et autres.
	 *
	 * @param long1
	 *            longitude du bord gauche
	 * @param long2
	 *            longitude du bord droit
	 * @param lat1
	 *            latitude du bord bas
	 * @param lat2
	 *            latitude du bord haut
	 * 
	 */
	 ...
	 * 
	 * @param lon
	 *            longitude du point ou positionner le texte.
	 * @param lat
	 *            latitude du point ou positionner le texte.
	 * @param txt
	 *            le texte a ecrire.
	 */
	...
	/**
	 * Attend un clic de souris sur l'image. Les coordonnees sont ensuite
	 * obtenues avec getClickLon et getClickLat
	 * 
	 * @return true si un clic a bien ete obtenu, false sinon (en cas
	 *         d'interruption forcee par exemple)
	 */
