...
public class Utils {
	...
	public static void checkVersion(int magic, int magic_attendu, int version, int version_attendue, String nomFichier,
			String nom_format) {
		...
		if (version != version_attendue) {
			...
			System.out.println(" (version Graphe.java = " + version_attendue + " (pour la lecture des " + nom_format
					+ "), version de " + nomFichier + " = " + version);
			System.exit(1);
		}
	}
