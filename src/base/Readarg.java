...
/**
 * La classe Readarg facilite la lecture de donnees depuis le clavier ou depuis
...
public class Readarg {
	...
	/**
	 * Obtient une chaine, ou bien depuis la ligne de commande, ou depuis
	 * l'entree standard.
	 * 
	 * @param msg
	 *            Message affiche avant de demander la chaine
	 */
	...
	/**
	 * Obtient un entier, ou bien depuis la ligne de commande, ou depuis
	 * l'entree standard.
	 * 
	 * @param msg
	 *            Message affiche avant de demander l'entier
	 */
	...
	/**
	 * Obtient un float, ou bien depuis la ligne de commande, ou depuis l'entree
	 * standard.
	 * 
	 * @param msg
	 *            Message affiche avant de demander le float.
	 */
